...
Revision ID: b0e9df27eac0
Revises: 
Create Date: 2024-11-22 13:46:21.801441
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('achievement_id', 'org_id', name='_achievement_org_uc')
    )
    ...
    sa.ForeignKeyConstraint(['org_id'], ['orgs.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('event_tag_id', 'org_id', name='_event_tag_org_uc')
    )
    ...
    sa.ForeignKeyConstraint(['org_id'], ['orgs.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('event_type_id', 'org_id', name='_event_type_org_uc')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('org_id', 'slack_space_id', name='_org_slack_uc')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('achievement_id', 'user_id', name='_achievement_user_uc')
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('expansion_id', 'user_id', name='_expansion_user_uc')
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('position_id', 'user_id', 'org_id', name='_position_user_org_uc')
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('event_id', 'user_id', 'is_planned', name='_event_user_planned_uc')
    )
    ...
    sa.ForeignKeyConstraint(['event_tag_id'], ['event_tags.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('event_id', 'event_tag_id', name='_event_event_tag_uc')
    )
    ...
    sa.ForeignKeyConstraint(['event_type_id'], ['event_types.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('event_id', 'event_type_id', name='_event_event_type_uc')
    )
