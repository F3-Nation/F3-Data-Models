...
def upgrade() -> None:
    ...
    op.execute(
        "UPDATE event_types SET event_category = 'first_f' WHERE category_id = 1"
    )
    op.execute(
        "UPDATE event_types SET event_category = 'second_f' WHERE category_id = 2"
    )
    op.execute(
        "UPDATE event_types SET event_category = 'third_f' WHERE category_id = 3"
    )
    op.alter_column(
        "event_types",
        "event_category",
...
def downgrade() -> None:
    ...
    op.bulk_insert(
        org_types_table,
        [
            {"id": 1, "name": "ao", "description": "Area of Operations"},
            {"id": 2, "name": "region", "description": "Region"},
            {"id": 3, "name": "area", "description": "Area"},
            {"id": 4, "name": "sector", "description": "Sector"},
            {"id": 5, "name": "nation", "description": "Nation"},
        ],
    )
    ...
    op.bulk_insert(
        ...
        [
            {"id": 1, "name": "first_f", "description": "First F"},
            {"id": 2, "name": "second_f", "description": "Second F"},
            {"id": 3, "name": "third_f", "description": "Third F"},
        ],
    )
    op.create_table(
        "achievements_x_org",
