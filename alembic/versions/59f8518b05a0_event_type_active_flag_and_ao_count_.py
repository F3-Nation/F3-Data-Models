"""event type active flag and ao_count updates from Spuds

Revision ID: 59f8518b05a0
Revises: 01807f1d41da
Create Date: 2025-06-05 07:39:57.872110
...
revision: str = "59f8518b05a0"
down_revision: Union[str, None] = "01807f1d41da"
...
def upgrade() -> None:
    ...
    op.add_column("event_types", sa.Column("is_active", sa.Boolean(), nullable=False, server_default=sa.text("true")))
    op.add_column("orgs", sa.Column("ao_count", sa.Integer(), nullable=True, server_default=sa.text("0")))
    op.execute("""
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("orgs", "ao_count")
    op.drop_column("event_types", "is_active")
    op.execute("""
-- Drop the trigger and function for AO count updates
DROP TRIGGER IF EXISTS update_org_ao_counts_trigger ON orgs;
DROP FUNCTION IF EXISTS update_org_ao_counts();
DROP FUNCTION IF EXISTS toggle_ao_count_trigger(disable BOOLEAN);
    """)
    # ### end Alembic commands ###
