...
def upgrade() -> None:
    ...
    op.add_column('event_tags', sa.Column('specific_org_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'event_tags', 'orgs', ['specific_org_id'], ['id'])
    op.add_column('event_types', sa.Column('specific_org_id', sa.Integer(), nullable=True))
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['event_type_id'], ['event_types.id'], name='event_types_x_org_event_type_id_fkey'),
    sa.ForeignKeyConstraint(['org_id'], ['orgs.id'], name='event_types_x_org_org_id_fkey'),
    sa.PrimaryKeyConstraint('event_type_id', 'org_id', name='event_types_x_org_pkey')
    )
    ...
    sa.ForeignKeyConstraint(['event_tag_id'], ['event_tags.id'], name='event_tags_x_org_event_tag_id_fkey'),
    sa.ForeignKeyConstraint(['org_id'], ['orgs.id'], name='event_tags_x_org_org_id_fkey'),
